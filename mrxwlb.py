...
for month in range(12, 12 + 1):
    days = calendar.monthrange(2024, month)[1] #数组的第二个位置为月份的天数
    for day in range(11, days + 1):
        title = '2024年{:02d}月{:02d}日新闻联播文字版'.format(month, day)
        url = 'http://mrxwlb.com/2024/{:02d}/{:02d}/{}/'.format(month, day, urllib.parse.quote(title))
